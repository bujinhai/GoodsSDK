...
/**
 * Create on 2019/10/14 15:49 by bll
 * 带侧滑功能的recyclerView
 */


public class GSlideRecyclerView extends IRecyclerView {
    ...
    public GSlideRecyclerView(Context context) {
        this(context, null);
    }

    public GSlideRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GSlideRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
